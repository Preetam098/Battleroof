      ...
      >
        ...
        <div className="mt-6">
          <button
            type="submit"
            disabled={loading}
            className="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 flex items-center justify-center transform  rounded-lg bg-button focus:outline-none "
          >
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <div className="text-xs text-color uppercase ">
            {" "}
            <span className="text-red-500 pr-1">❤</span> Battle roof
          </div>
